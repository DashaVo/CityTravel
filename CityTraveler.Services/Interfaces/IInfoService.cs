...
namespace CityTraveler.Services.Interfaces
{
    ...
    {
        public Task<EntertainmentShowDTO> GetUserMostPopularEntertaimentInTripsAsync(Guid userId = default);
        public Task<EntertainmentShowDTO> GetMostPopularEntertaimentInTripsAsync();
