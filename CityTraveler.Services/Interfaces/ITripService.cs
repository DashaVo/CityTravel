...
namespace CityTraveler.Services.Interfaces
{
    public interface ITripService 
    {
        ...
        public Task<bool> AddEntertainmetToTripAsync(Guid tripId, Guid newEntertainmentId);
        ...
        public Task<IEnumerable<TripPrewievDTO>> GetTripsByUserId(Guid userId);
        public Task<IEnumerable<TripPrewievDTO>> GetTripsByEntertainmentId(Guid entretainmentId, int skip = 0, int take = 5);
        public IEnumerable<TripDTO> GetTripDTOs(Guid userId);
        public IEnumerable<TripPrewievDTO> GetTripPrewievDTOs(Guid userId);
        public Task<bool> UpdateDefaultTrip(DefaultTripDTO defaultTripDTO);
